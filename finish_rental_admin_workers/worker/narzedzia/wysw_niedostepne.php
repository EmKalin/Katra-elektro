...
<body>
    ...
    <?php
        ...
        $wys_narz = "SELECT * FROM `elements` WHERE `availability` = 0";
    ...
    <br><br>
    <hr>
    <h3 style="text-align:center;">Niedostępne narzędzia</h3>
    <div>
        <a style="text-align:left; margin-left:200px; margin-bottom:50px;" class="btn btn-primary" href="http://localhost/projekt/worker/narzedzia/narzedzia.php" role="button">Wszystkie</a>
        <a style="text-align:left; margin-left:50px; margin-bottom:50px;" class="btn btn-primary" href="http://localhost/projekt/worker/narzedzia/wysw_dostepne.php" role="button">Dostępne</a>
        <a style="text-align:left; margin-left:50px; margin-bottom:50px;" class="btn btn-primary" href="http://localhost/projekt/worker/narzedzia/wysw_niedostepne.php" role="button">Niedostępne</a>
