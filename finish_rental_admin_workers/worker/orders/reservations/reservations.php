...
<body>
    ...
    <div style="text-align:left;">
        <a style="text-align:center; margin-left:350px; margin-bottom:50px;" class="btn btn-secondary" href="http://localhost/projekt/worker/orders/reservations/reservations.php" role="button">Aktwyne</a>
        <a style="text-align:center; margin-left:50px; margin-bottom:50px;" class="btn btn-secondary" href="http://localhost/projekt/worker/orders/reservations/cancelled_reservations.php" role="button">Anulowane</a>
    <div>
                ...
                <?php
                    while($element = $statement->fetch()){
                        ...
                        echo "<td style='text-align:center;'>". "<a href='../modify_order.php?id=".$element['id']."'>" ."Zmień". "</a>" .
                            ...
                            ."</td>";
                        echo "<td style='text-align:center;'>"."<a href='make_rent.php?id=".$element['id']."'>" ."Zrealizuj". "</a>" . "</td>";
                        echo "</tr>";
                    }
