...
<body>
    ...
    <div style="text-align:left;">
        <a style="text-align:center; margin-left:510px; margin-bottom:50px;" class="btn btn-secondary" href="http://localhost/projekt/worker/orders/rents/rents.php" role="button">Aktwyne</a>
        <a style="text-align:center; margin-left:50px; margin-bottom:50px;" class="btn btn-secondary" href="http://localhost/projekt/worker/orders/rents/end_rents.php" role="button">Zakończone</a>
        <a style="text-align:center; margin-left:50px; margin-bottom:50px;" class="btn btn-secondary" href="http://localhost/projekt/worker/orders/rents/cancelled_rents.php" role="button">Anulowane</a>
