...
<body>
    ...
    <div>
        ...
        <label for="new_user" style="margin-left:200px;margin-bottom:50px;">Dodaj użytkownika</label>
            <div class="form-row" id="new_user">
                <div class="form-group col-md-2" style="margin-left:200px;">
                    ...
                    <input pattern=".{3,}" required title="Minimum 3 znaki" type="text" class="form-control" id="login_input" name="login_input" placeholder="Login użytkownika">
                </div>
                ...
                <div class="form-group col-md-2" style="margin-left:50px;">
                    ...
                    <input type="text" class="form-control" id="lastname_input" name="lastname_input" placeholder="Nazwisko użytkownika">
                </div>
                <div class="form-group col-md-2" style="margin-left:1015px;">
                    <label for="phone_input">Numer telefonu</label>
                    <input type="float" class="form-control" id="phone_input" name="phone_input" placeholder="Komórkowy/Stacjonarny">
                </div>
                </div>
