...
<body>
    ...
    <?php
        ...
        $wys_zamowienia = 'SELECT reservations.id, elements.element_name as element_name,
                            ...
                            WHERE reservations.status=-2 OR reservations.status=-1 OR reservations.status=2 AND reservations.client_id='
            ...
            <thead class="thead-dark">
                ...
                <?php
                    while($element = $statement->fetch()){
                        ...
                        echo "<td style='text-align:center;'>".'<a style="pointer-events: none; cursor: default;"href='."../remove_order.php?id=".$element['id']."'>" ."  Anuluj". "</a>"
                            ."</td>";
                        echo "</tr>";
                    }
